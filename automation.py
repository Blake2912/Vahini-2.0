...
class Automation:
    ...
    def __check_if_destination_is_reached(self, current_coord, dest_coord):
        ...
        square_dist = (dest_coord[0] - current_coord[0]
                       ) ** 2 + (dest_coord[1] - current_coord[1]) ** 2
    ...
    def automate_linear(self):
        ...
        state = 0  # stop now
        current_coord = gps.mock_gps_coordinates(
            state, self.start_coordinates.point_coordinate)
