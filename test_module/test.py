...
class TestTree:
    def __init__(self, gt, start_node, end_node):
        ...
        if self.start_node == 'basic_science' and self.end_node == 'ganesha_statue':
        ...
        elif self.start_node == 'ganesha_statue' and self.end_node == 'hostel_turn':
        ...
        elif self.start_node == 'hostel_turn' and self.end_node == 'volley_ball_court':
        ...
        elif self.start_node == 'volley_ball_court' and self.end_node == 'teacher_parking':
            self.G.add_tree(tc.tree10.point_coordinate, start_node, end_node)
            self.G.save_and_return()

        elif self.start_node == 'teacher_parking' and self.end_node == 'basic_science':
